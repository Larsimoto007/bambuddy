...
class VirtualPrinter(Base):
    ...
    mode: Mapped[str] = mapped_column(String(20), default="immediate")  # immediate|review|print_queue|proxy|middleware
    ...
    serial_port: Mapped[str | None] = mapped_column(String(100), nullable=True)  # middleware mode: e.g. /dev/ttyUSB0
    baudrate: Mapped[int | None] = mapped_column(Integer, nullable=True)  # middleware mode: e.g. 115200
